...
REPLACEMENTS = [
    ...
    ('>9 min read<', '>閱讀時間 9 分鐘<'),
    ('>11 min read<', '>閱讀時間 11 分鐘<'),
    ('>12 min read<', '>閱讀時間 12 分鐘<'),
    ('>10 min read<', '>閱讀時間 10 分鐘<'),
...
ALT_TEXT = {
    ...
    'Manufacturing and industrial facility in Arizona': '亞利桑那製造業與工業設施',
